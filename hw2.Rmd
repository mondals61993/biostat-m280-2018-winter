...
There are strong relationships (resembling quadratic) between price and length as well as price and width. 
...
grid.arrange(d_cut, d_color, nrow = 1)

```

There seems to be more of a relationship between color and price, although there is quite a bit of variance. 
```{r}
#cut and length 
